...
class PurchasesHistoryBloc extends Bloc<PurchasesHistoryEvent, PurchasesHistoryState> {
  ...
  PurchasesHistoryBloc({required PurchaseMembershipService service}) :
  ...
  Future<void> _onGetPurchasesHistory(
    ...
    try {
      ...
      final List<UserMembershipModel> userMemberships = await _purchaseService.getUserMembershipHistoryByUserId();
