...
class MembershipWidget extends StatelessWidget {
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  //_buildMembershipTypeSubtitle(context),
                ],
              ),
            ),
          ),
  ...
  Widget _buildMembershipTypeSubtitle(BuildContext context) {
    String typeText = '';
    switch (membership.type) {
      case 'SessionLimited':
        typeText = 'Обмеження за кількістю тренувань';
        break;
      case 'TimeLimited':
        typeText = 'Обмеження за часом';
        break;
      case 'Combined':
        typeText = 'Комбінований';
        break;
      default:
        typeText = membership.type;
    }
